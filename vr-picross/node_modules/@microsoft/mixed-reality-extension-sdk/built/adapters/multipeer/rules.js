...
exports.Rules = {
    ...
    // ========================================================================
    'create-animation': Object.assign(Object.assign({}, exports.DefaultRule), { synchronization: {
    ...
    // ========================================================================
    'interpolate-actor': Object.assign(Object.assign({}, exports.DefaultRule), { synchronization: {
            stage: 'create-animations',
            before: 'queue',
            during: 'allow',
            after: 'allow'
    ...
    'object-spawned': Object.assign(Object.assign({}, ClientOnlyRule), { session: Object.assign(Object.assign({}, exports.DefaultRule.session), { beforeReceiveFromClient: (session, client, message) => {
                ...
                const exclusiveUser = message.payload.actors && message.payload.actors.length ?
    ...
    // ========================================================================
    'set-animation-state': Object.assign(Object.assign({}, exports.DefaultRule), { synchronization: {
            stage: 'create-animations',
            before: 'ignore',
            during: 'queue',
            after: 'allow'
    ...
    'set-behavior': Object.assign(Object.assign({}, exports.DefaultRule), { synchronization: {
            ...
            after: 'allow'
                ...
                if (syncActor) {
                    ...
                    log_1.log.error('app', `Sync: set-behavior on unknown actor ${message.payload.actorId}`);
                }
                return message;
            } }) }),
    // ========================================================================
    ...
    // ========================================================================
    'sync-animations': Object.assign(Object.assign({}, exports.DefaultRule), { synchronization: {
            stage: 'sync-animations',
            before: 'error',
            during: 'allow',
            after: 'error'
