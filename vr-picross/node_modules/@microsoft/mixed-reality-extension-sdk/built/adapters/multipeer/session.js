...
class Session extends events_1.EventEmitter {
    ...
    setAuthoritativeClient(clientId) {
        ...
        if (this.conn instanceof __1.EventedConnection) {
        ...
        const toApp = this.conn instanceof __1.EventedConnection ? this.conn : null;
        ...
        const toNewAuthority = newAuthority.conn instanceof __1.EventedConnection ? newAuthority.conn : null;
        if (toNewAuthority) {
        ...
        const toOldAuthority = oldAuthority && oldAuthority.conn instanceof __1.EventedConnection
    ...
    cacheAnimationCreationRequest(payload) {
        this._animationCreatorSet.set(payload.id, payload);
    }
    cacheAnimationCreation(animId, creatorId, duration) {
