 ...
 */
export declare type RigidBodyCommands = Payload & {
 ...
 */
export declare type RigidBodyMovePosition = Payload & {
 ...
 */
export declare type RigidBodyMoveRotation = Payload & {
 ...
 */
export declare type RigidBodyAddForce = Payload & {
 ...
 */
export declare type RigidBodyAddForceAtPosition = Payload & {
 ...
 * App to engine. Add force rigidbody command
 */
export declare type RigidBodyAddTorque = Payload & {
 ...
 * App to engine. Add force at position rigidbody command
 */
export declare type RigidBodyAddRelativeTorque = Payload & {
 ...
 */
export declare type CollisionEventRaised = Payload & {
 ...
 */
export declare type TriggerEventRaised = Payload & {
