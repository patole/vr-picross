 ...
 */
export declare type CollisionHandler = (data: CollisionData) => void;
/**
 ...
 */
export declare type TriggerHandler = (otherActor: Actor) => void;
/**
 * The collision state for the collsion event.
 */
export declare type CollisionEventState = 'enter' | 'exit';
/**
