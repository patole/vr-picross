 ...
 */
import { Asset, Material, MaterialLike, Mesh, Prefab, Sound, SoundLike, Texture, TextureLike, VideoStream, VideoStreamLike } from '.';
import { Context } from '..';
...
export declare class AssetContainer {
    ...
    private sendPayloadAndGetReply;
}
